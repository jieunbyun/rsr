...
In this case, try setting 'track_overrides=True' to see which reference states are being overridden by subsequent rounds. This can help identify the source of incoherence in your system function.
