...
# 4. **System state** is determined by applying the pre-computed references to the post-cascade component vector via `rsr.classify_samples_with_indices`. Unknown samples are resolved by calling `s_fun` directly.
