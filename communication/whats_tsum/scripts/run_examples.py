...
if __name__ == "__main__":
    ...
    """
    _ = rsr.run_rule_extraction_by_mcs(
    ...
    """_ = rsr.run_rule_extraction_by_mcs( # to not interfere with memory measurement of the next runs
        # Problem-specific callables / data
    ...
    probs = torch.tensor(probs, dtype=torch.float32, device=device)
    _ = rsr.run_rule_extraction_by_mcs( # to not interfere with memory measurement of the next run
        # Problem-specific callables / data
    ...
    _ = rsr.run_rule_extraction_by_mcs( # to not use up residence set size
        # Problem-specific callables / data
    ...
    _ = rsr.run_rule_extraction_by_mcs( # to not interfere with memory measurement of the next run
        # Problem-specific callables / data
        sfun=rg_data3['sys_func_conn_rsr'],
        probs=probs,
        row_names=row_names,
        n_state=n_state,
        sys_upper_st=1,
        unk_prob_thres = 1e-5,
        unk_prob_opt = 'abs',
        output_dir=ds_root3 / "rsr_conn",
    )

    ## Third example - Global connectivity
    _ = rsr.run_rule_extraction_by_mcs( # to not use up residence set size
        # Problem-specific callables / data
        sfun=rg_data3['sys_func_global_conn_rsr'],
        probs=probs,
        row_names=row_names,
        n_state=n_state,
        sys_upper_st=1,
        unk_prob_thres = 1e-5,
        unk_prob_opt = 'abs',
        output_dir=ds_root3 / "rsr_global_conn",
    )"""
    ...
    """_ = rsr.run_rule_extraction_by_mcs( # to not interfere with memory measurement of the next run
        # Problem-specific callables / data
        sfun=rg_data4['sys_func_conn_rsr'],
        probs=probs,
        row_names=row_names,
        n_state=n_state,
        sys_upper_st=1,
        unk_prob_thres = 1e-5,
        unk_prob_opt = 'abs',
        output_dir=ds_root4 / "rsr_conn",
    )"""

    ## Fourth example - Global connectivity
    _ = rsr.run_rule_extraction_by_mcs( # to not use up residence set size
        # Problem-specific callables / data
        sfun=rg_data4['sys_func_global_conn_rsr'],
        probs=probs,
        row_names=row_names,
        n_state=n_state,
        sys_upper_st=1,
        unk_prob_thres = 1e-5,
        unk_prob_opt = 'abs',
        output_dir=ds_root4 / "rsr_global_conn",
        save_every=10000,
    )